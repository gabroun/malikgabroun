...
date: '2020/08/06'
title: 'How to Add MetaData in Vue Using Vue-Meta'
tags: ['javascript', 'vue']
summary: 'In this post, we will be looking into how to add vue-meta to our project and use it to handle metadata inside the component'
images: 'images/thumbnails/imacScreen.jpeg'
