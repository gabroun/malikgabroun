---
type: 'post'
path: '/intro-to-algolia-in-gatsby-part-i'
date: '2020/02/18'
title: 'An Introduction to adding Algolia search to your gatsby site (Part 1)'
tags: ['js, gatsby, react']
summary: 'In this post we will be looking into configuring and adding algolia instant search component to your gatsby site'
images: 'images/thumbnails/searching.jpeg'
imageAuthorID: '@amartino20'
imageAuthor: 'Anthony Martino'
keywords: ['Algolia, Gatsby, adding algolia to gatsby']
---
